...
#define MOTOR_CTRL_FASTLOOP_FREQ                   5000.0f	//c (15000.0f)                  /*[Hz], fast-loop frequency at least 1.2 decade above maximum electrical frequency, 1.5kHz~>25kHz*/
...
/*********SPEED Controller*********/
#define MOTOR_CTRL_SPEED_BW                        5.0f	//c (15.0f)                      /*[Hz], Speed loop bandwidth*/ //(15.0f)
...
#if defined(CTRL_METHOD_RFO) || defined(CTRL_METHOD_TBC)
/*********Current Controller*********/
#define MOTOR_CTRL_CURRENT_BW                      250.0f	//c (750.0f)                      /*[Hz], Current loop bandwidth*/
...
#else
	#define MOTOR_CTRL_VOLT_STARTUP_THRESH             (MOTOR_NORM_SPEED*0.05f)      /*[RPM], startup threshold*/
	#define MOTOR_CTRL_VOLT_VF_OFFSET                  (0.60f)                       /*[V], V/F ramp voltage offset*/
	#define MOTOR_CTRL_VOLT_VF_RATIO                   (15E-3f)                     /*[V/(Rad/secz], V/f ramp slope*/
#endif
...
/*******Motor*******/
...
#endif
#if PROVEN //(MOTOR == BLDC)	//works - Profiler specifications
	#define MOTOR_POLE                                 4.0f                       	/*[],  motor poles*/
	#define MOTOR_LQ                                   794.0E-6f                  	/*[H], Stator q-axis inductance*/
	#define MOTOR_LD                                   689.0E-6f                  	/*[H], Stator d-axis inductance*/
	#define MOTOR_I_AM                                 1.91E-2f                    	/*[Wb],  Rotor flux linkage*/
	#define MOTOR_R                                    2.81E-1f                  	/*{Ohm],  stator resistance*/
	#define MOTOR_TORQUE_MAX                           (0.390f)                     /*[Nm],  maximum torque*/
	#define MOTOR_CURRENT_PEAK                         (10.80f)                     /*[A],  peak current rating*/
	#define MOTOR_CURRENT_CONT                         (3.50f)                      /*[A],  continuous current rating*/
	#define MOTOR_ID_MAX                               (1.75f)                      /*[A], maximum d-axis current*/
...
#endif
#if PROVEN //(MOTOR == PMSM_14P)	//works - chatGPT specifications
	#define MOTOR_POLE                                 14.0f                       	/*[],  motor poles*/
	#define MOTOR_LQ                                   0.8E-3f                  	/*[H], Stator q-axis inductance*/
	#define MOTOR_LD                                   0.8E-3f                  	/*[H], Stator d-axis inductance*/
...
#endif
#if PROVEN //(MOTOR == PMSM_14P)	//works - LCR meter specifications
	#define MOTOR_POLE                                 14.0f                       	/*[],  motor poles*/
	#define MOTOR_LQ                                   1.1925E-3f                  	/*[H], Stator q-axis inductance*/
	#define MOTOR_LD                                   1.1925E-3f                  	/*[H], Stator d-axis inductance*/
	#define MOTOR_I_AM                                 (6.0E-3f)                    /*[Wb],  Rotor flux linkage*/
	#define MOTOR_R                                    1.025f                  		/*{Ohm],  stator resistance*/
	#define MOTOR_TORQUE_MAX                           (0.390f)                     /*[Nm],  maximum torque*/
	#define MOTOR_CURRENT_PEAK                         (10.80f)                     /*[A],  peak current rating*/
	#define MOTOR_CURRENT_CONT                         (3.50f)                      /*[A],  continuous current rating*/
	#define MOTOR_ID_MAX                               (1.75f)                      /*[A], maximum d-axis current*/
	...
	#define MOTOR_MAX_SPEED                            480.0f                    	/*[RPM],  maximum no load speed*/
#endif
#if PROVEN //(MOTOR == PMSM_20P)	// - chatGPT specifications
	#define MOTOR_POLE                                 20.0f                       	/*[],  motor poles*/
	#define MOTOR_LQ                                   5.0E-3f                  	/*[H], Stator q-axis inductance*/
	#define MOTOR_LD                                   5.0E-3f                  	/*[H], Stator d-axis inductance*/
	#define MOTOR_I_AM                                 (6.0E-3f)//1.3E-2f                    	/*[Wb],  Rotor flux linkage*/
	#define MOTOR_R                                    0.1f                  		/*{Ohm],  stator resistance*/
	#define MOTOR_TORQUE_MAX                           (0.390f)                     /*[Nm],  maximum torque*/
	#define MOTOR_CURRENT_PEAK                         (10.8f)                     	/*[A],  peak current rating*/
	#define MOTOR_CURRENT_CONT                         (3.5f)                      	/*[A],  continuous current rating*/
	#define MOTOR_ID_MAX                               (1.75f)                      	/*[A], maximum d-axis current*/
	#define MOTOR_VOLTAGE                              (24.0f)                      /*[V], motor voltage*/
	#define MOTOR_NORM_SPEED                           180.0f                    	/*[RPM], nominal speed*/
	#define MOTOR_MAX_SPEED                            240.0f                   	/*[RPM],  maximum no load speed*/
#endif
#if PROVEN //(MOTOR == PMSM_20P)	// - LCR meter specifications
	#define MOTOR_POLE                                 20.0f                       	/*[],  motor poles*/
	#define MOTOR_LQ                                   1.43E-3f                  	/*[H], Stator q-axis inductance*/
	#define MOTOR_LD                                   1.43E-3f                  	/*[H], Stator d-axis inductance*/
	#define MOTOR_I_AM                                 (6.0E-3f)//1.3E-2f                    	/*[Wb],  Rotor flux linkage*/
	#define MOTOR_R                                    0.9745f                  		/*{Ohm],  stator resistance*/
	#define MOTOR_TORQUE_MAX                           (0.390f)                     /*[Nm],  maximum torque*/
	#define MOTOR_CURRENT_PEAK                         (10.8f)                     	/*[A],  peak current rating*/
	#define MOTOR_CURRENT_CONT                         (3.5f)                      	/*[A],  continuous current rating*/
	#define MOTOR_ID_MAX                               (1.75f)                      	/*[A], maximum d-axis current*/
	...
	#define MOTOR_MAX_SPEED                            240.0f                   	/*[RPM],  maximum no load speed*/
#endif
#if (MOTOR == PMSM_20P)	// - experimental
	#define MOTOR_POLE                                 20.0f                       	/*[],  motor poles*/
	#define MOTOR_LQ                                   1.43E-3f                  	/*[H], Stator q-axis inductance*/
	#define MOTOR_LD                                   1.43E-3f                  	/*[H], Stator d-axis inductance*/
	#define MOTOR_I_AM                                 (6.0E-3f)//1.3E-2f                    	/*[Wb],  Rotor flux linkage*/
...
#define MOTOR_CTRL_FASTLOOP_FREQ_M1                   5000.0f	//c (15000.0f)                     /*[Hz], fast-loop frequency at least 1.2 decade above maximum electrical frequency, 1.5kHz~>25kHz*/
...
#endif
#if defined(CTRL_METHOD_RFO)
#define MOTOR_CTRL_COMMAND_MAX_POSITION_M1             (360.f)                       /*[deg], maximum current command*/
#endif
/*******Feedback*******/
/*********Hall Sensor*********/
...
/*********SPEED Controller*********/
#define MOTOR_CTRL_SPEED_BW_M1                       5.0f	//c (15.0f)                       /*[Hz], Speed loop bandwidth*/ //(15.0f)
...
#if defined(CTRL_METHOD_RFO) || defined(CTRL_METHOD_TBC)
/*********Current Controller*********/
#define MOTOR_CTRL_CURRENT_BW_M1                     250.0f	//c (750.0f)                          /*[Hz], Current loop bandwidth*/
